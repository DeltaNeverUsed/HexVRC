...
namespace BefuddledLabs.Magic.Instructions.StackManipulation
{
    public static class Rearrange
    {
        ...
        public const string Description = "Rearranges the top elements of the stack based on the given numerical code, which is the index of the permutation wanted.";
