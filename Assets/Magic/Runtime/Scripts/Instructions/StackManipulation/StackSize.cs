...
namespace BefuddledLabs.Magic.Instructions.StackManipulation {
    public static class StackSize {
        ...
        public const string Description = "Pushes the size of the stack as a number to the top of the stack. (For example, a stack of [0, 1] will become [0, 1, 2].)";
        ...
        {
            info.Stack.Push(StackItem.CreateStackItem((float)info.Stack.Count));
