...
namespace BefuddledLabs.Magic.Instructions.StackManipulation
{
    public static class Copy
    {
        ...
        public const string Description = "Removes the number at the top of the stack, then copies the top iota of the stack that number of times. (A count of 2 results in two of the iota on the stack, not three.)";
