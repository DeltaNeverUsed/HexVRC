...
namespace BefuddledLabs.Magic.Instructions.LogicalOperators {
    public static class LessThanEqual {
        public const string Path = "qq";

        #region Docs

        public const string Description = "If the first argument is less than or equal to the second, return True. Otherwise, return False.";
